...
class InvokeContext:
    def __init__(self, arg: HalDevice, /) -> None: ...

class _InvokeStatics:
    ...

class ArgumentPacker:
    def __init__(self, statics: _InvokeStatics, arg_descs: list | None = None) -> None: ...

    def pack(self, arg0: InvokeContext, arg1: Sequence, arg2: dict, /) -> VmVariantList: ...
...
class MemoryAccess(int):
    ...
    UNALIGNED: ClassVar[MemoryAccess] = ...
...
class HalAllocator:
    ...
    ) -> HalBuffer | HalBufferView: ...
    def allocate_buffer_view_copy(
        self,
        memory_type: Union[MemoryType, int],
        allowed_usage: Union[BufferUsage, int],
        device: HalDevice,
        ...
        requires_target_buffer_import: bool,
    ) -> HalBufferView: ...
    ...
    def export_buffer(self, buffer: HalBuffer) -> Any: ...
    def import_buffer(self, external_buffer: Any): ...
    def trim(self) -> None: ...
    @property
...
class HalBuffer:
    ...
    def create_view_like(self, like: HalBufferView) -> HalBufferView: ...
...
class HalDevice:
    ...
    def create_dlpack_capsule(
        ...
        """
        ...
    def from_dlpack_capsule(
        self,
        capsule: Any,
        memory_type: int = MemoryType.DEVICE_LOCAL,
        memory_access: int = MemoryAccess.READ | MemoryAccess.WRITE,
    ) -> HalBufferView:
